...
<div class="container">
	<ul class="nav nav-tabs">
		<?php
			...
			?>
				<li class="active"><a data-toggle="tab" href="#<?php echo $frow['catname'] ?>">
				<?php echo $frow['catname'] ?></a></li>
			<?php
			...
			?>
				...
				style="margin-top:20px;">
					<?php
								...
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											{echo "upload/noimage.jpg";} else{echo $pfrow['photo'];} ?>" 
						...
						if($inc == 1) echo "<div class='col-md-3'></div><div class='col-md-3'>
						</div><div class='col-md-3'></div></div>"; 
						if($inc == 2) echo "<div class='col-md-3'></div><div class='col-md-3'>
						</div></div>"; 
			...
			while($trow=$cquery->fetch_array()){
				...
				<div id="<?php echo $trow['catname']; ?>" class="tab-pane fade" style="margin-top:20px;">
					<?php
								...
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											{echo "upload/noimage.jpg";} else{echo $prow['photo'];} ?>"
											 height="225px;" width="100%">
										</div>
						...
						if($inc == 1) echo "<div class='col-md-3'></div>
						<div class='col-md-3'></div><div class='col-md-3'></div></div>"; 
						if($inc == 2) echo "<div class='col-md-3'></div>
