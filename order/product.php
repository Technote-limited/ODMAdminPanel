...
<div class="container">
	<h1 class="page-header text-center">PRODUCTS AVAILABLE</h1>
	<div class="row">
		<div class="col-md-12">
			...
			<a href="#addproduct" data-toggle="modal" class="pull-right btn btn-primary">
			<span class="glyphicon glyphicon-plus"></span> Product</a>
		</div>
	</div>
